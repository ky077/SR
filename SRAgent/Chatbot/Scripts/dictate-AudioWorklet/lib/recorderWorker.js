...
function record(inputBuffer){
  ...
  // **********************************************************************************************
  recBuffersAll.push(inputBuffer[0]);
  recLengthAll += inputBuffer[0].length;
  // **********************************************************************************************
}
...
function exportWAV(type){
  ...
  var interleaved = mergeBuffers(recBuffersAll, recLengthAll);
  // **********************************************************************************************
...
function encodeWAV(samples){
  ...
  view.setUint16(22, 1/*numChannels*/, true);
  // **********************************************************************************************
  /* sample rate */
  ...
  view.setUint16(32, 2/*numChannels * 2*/, true);
  // **********************************************************************************************
  /* bits per sample */
