<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OpenWebUIChatSession2.aspx.cs" Inherits="SRAgent.OpenWebUIChatSession2" %>
...
$("#textInput").val(data.text);
            ...
            function appendToChatHistory(text1, text2, audioIndex1, audioIndex2, isChatbot) {
                ...
                if (isChatbot) {
                    ...
                    $(".chatInterface-frame.right .dialog-text .play-audio").hide();
                }
