(function(window){
  ...
  var Recorder = function(source, cfg){
    ...
    var init = async () => {
        await this.context.audioWorklet.addModule('../../Chatbot/Scripts/dictate/lib/recorder-worklet-processor.js');
        ...
        this.node.connect(this.context.destination); // optional
    };
    ...
    this.clear = function(clearAll){
      worker.postMessage({ command: 'clear', clearAll: clearAll });
    }
    // ********************************************************************************************
