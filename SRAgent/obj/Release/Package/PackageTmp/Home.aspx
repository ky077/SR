<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="SRAgent.Home" %>
    ...
    <div class="futuristic-frame wow animate__animated animate__zoomIn">
      <div class="futuristic-frame-border">
        <div class="futuristic-frame-content"> 
          ...
          <div class="row g-5">
            <div class="col-lg">
              <div class="index-btn chat"> <a id="chat" class="btn btn-outline-secondary btn-lg rounded-pill w-100" href="ChatTopic.aspx"><%= Resources.Global.Home3 %></a> <i class="fa-regular fa-comments" aria-hidden="true"></i> </div>
            </div>
            <div class="col-lg">
              <div class="index-btn practice"> <a id="practice" class="btn btn-outline-tertiary btn-lg rounded-pill w-100" href="PracticeTopic.aspx"><%= Resources.Global.Home4 %></a> <i class="fa-solid fa-microphone-lines" aria-hidden="true"></i> </div>
            </div>
            <div class="col-lg">
              <div class="index-btn"> <a id="statistics" class="btn btn-outline-primary btn-lg rounded-pill w-100" href="Statistics.aspx"><%= Resources.Global.Home5 %></a> <i class="fa-regular fa-file-lines" aria-hidden="true"></i> </div>
            </div>
          </div>
          <!-- --> 
        </div>
...
<script src="Content/js/main.js"></script>
    <script>
        $(document).ready(function () {
            //const host = "localhost:44342"; // teemi.tw/Chatbot
            ...
            function getCulture() {
                ...
                if (params.has("culture")) {
                    let culture = params.get("culture");
                    if (culture == "en-US" || culture == "zh-CN" || culture == "zh-TW" || culture == "id-ID" || culture == "vi-VN")
                        s = culture;
                }
            ...
            //    window.location.replace("https://" + host + "/ChatTopic.aspx?culture=" + $("#culture").val());
            //});

            //$("#practice").click(function (event) {
            //    event.preventDefault();
            //    window.location.replace("https://" + host + "/PracticeTopic.aspx?culture=" + $("#culture").val());
            //});

            //$("#statistics").click(function (event) {
            //    event.preventDefault();
            //    window.location.replace("https://" + host + "/Statistics.aspx?culture=" + $("#culture").val());
            //});
        ...
        //        if (culture == "en-US" || culture == "zh-CN" || culture == "zh-TW" || culture == "id-ID" || culture == "vi-VN")
        //            window.location.href = "https://" + host + "/Home.aspx?culture=" + culture;
        //    } else {
        //        $("#culture").val(culture);
        //        setCookie("culture", culture, 365);
        //    }
